    ...
    public void render(T entity, float tickDelta, PoseStack matrices, MultiBufferSource vertexConsumers, int light, int overlay) {
        ...
        try {
            ...
            for (int i = 0; i < maxArrivals; i++) {
                ...
                textRenderer.drawInBatch(destinationString, 0, 0, trueColor, false, matrices.last().pose(), vertexConsumers, Font.DisplayMode.NORMAL, 0, MAX_LIGHT_GLOWING);
                matrices.popPose();
                matrices.pushPose();
                matrices.translate(0.5, 0, 0.5);
                ...
                textRenderer.drawInBatch(destinationString, leftLength, 0, trueColor, false, matrices.last().pose(), vertexConsumers, Font.DisplayMode.NORMAL, 0, MAX_LIGHT_GLOWING);
                matrices.popPose();
                matrices.pushPose();
                matrices.translate(0.5, 0, 0.5);
                UtilitiesClient.rotateYDegrees(matrices, (rotate90 ? 90 : 0) - facing.toYRot());
                ...
                textRenderer.drawInBatch(destinationString2, 0, 0, trueColor, false, matrices.last().pose(), vertexConsumers, Font.DisplayMode.NORMAL, 0, MAX_LIGHT_GLOWING);
                matrices.popPose();
                matrices.pushPose();
                matrices.translate(0.5, 0, 0.5);
                UtilitiesClient.rotateYDegrees(matrices, (rotate90 ? -90 : -180) - facing.toYRot());
                ...
                textRenderer.drawInBatch(destinationString2, leftLength2, 0, trueColor, false, matrices.last().pose(), vertexConsumers, Font.DisplayMode.NORMAL, 0, MAX_LIGHT_GLOWING);
                matrices.popPose();
            }
        } catch (Exception e) {
            e.printStackTrace();
