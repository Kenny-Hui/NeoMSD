...
public abstract class LineDataBase extends PersistentStateMapper {
    ...
    /**
     * We don't use CompoundTag for storing, override {@link LineDataBase#save(File, HolderLookup.Provider)} instead for hooking
     */
    @Override
    public final CompoundTag save(CompoundTag compoundTag, HolderLookup.Provider registries) {
        return compoundTag;
    }
